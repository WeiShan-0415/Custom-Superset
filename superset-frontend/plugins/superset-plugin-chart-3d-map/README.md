...
remain distinct. Clicking the epicentre shows its details and calculated zone
radii. Warning rows continue to color Malaysian state polygons; their
`severity` value is used when no chart metric is selected.
