 ...
 * under the License.
 */
import { SupersetPluginChartCustomDistrictMap } from '../src';
 ...
 */
describe('superset-plugin-chart-custom-district-map', () => {
  it('exists', () => {
    expect(SupersetPluginChartCustomDistrictMap).toBeDefined();
  });
});
