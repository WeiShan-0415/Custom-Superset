...
import { SupersetPluginChartSelectedIncident } from '../src';
 ...
 */
describe('superset-plugin-chart-selected-incident', () => {
  it('exists', () => {
    expect(SupersetPluginChartSelectedIncident).toBeDefined();
  });
});
