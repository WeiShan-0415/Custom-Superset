...
export default function buildQuery(
  formData: SupersetPluginChartHazardRiskOutlookQueryFormData,
) {
  const {
    hazard_column: hazardColumn = 'title',
    severity_column: severityColumn = 'severity',
    valid_from_column: validFromColumn = 'valid_from',
    valid_to_column: validToColumn = 'valid_to',
  } = formData;
