 ...
 * under the License.
 */
jest.mock('../src/plugin/controlPanel', () => ({
  __esModule: true,
  default: {},
}));
import { SupersetPluginChartHazardRiskOutlook } from '../src';
 ...
 */
describe('superset-plugin-chart-hazard-risk-outlook', () => {
  it('exists', () => {
    expect(SupersetPluginChartHazardRiskOutlook).toBeDefined();
  });
});
